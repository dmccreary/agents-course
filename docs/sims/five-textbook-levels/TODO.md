...
**MicroSim:** five-textbook-levels
**Repository:** agents-course
...
- **Framework:** p5.js
- **Detected subjects:** Mathematics, Computer Science, Chemistry, Economics
- **Visualization types:** animation, simulation, graph, diagram, interactive-demo, network
- **Has main.html:** Yes
- **Has index.md:** Yes
